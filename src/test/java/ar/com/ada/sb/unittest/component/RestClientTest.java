...
import ar.com.ada.sb.junittest.model.rest.Todo;
...
class RestClientTest {
    ...
    @Test
    public void whenCallOneEndpointTodosThenResturTodoResponse() {
        // GIVEN
    ...
    @Test
    public void whenCallAllEndpointTodosThenResturTodoListResponse() {
        // GIVEN
    ...
    @Test
    public void whenPostndpointTodosThenResturTodoResponseCreate() {
        // GIVEN
        String url = "https://jsonplaceholder.typicode.com/todos";
        RestClient<Todo> client = new RestClient();
